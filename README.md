Ehandler is an implementation of (some kind of) event listener where producers produce messages (of some type) and consumers (i.e. handlers) consume these messages. 
